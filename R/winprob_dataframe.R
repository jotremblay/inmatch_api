...
#'
#' Gets players current chances of winning point based on the score at the start and the outcome. The win probability is with respect to 'player 1' whether the player is serving or receiving
#'
